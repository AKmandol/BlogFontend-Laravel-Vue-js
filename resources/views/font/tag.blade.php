            ...
            <div class="col-12 col-md-10 col-lg-8">
                <div class="row">
                        ...
                        <div class="col-12 col-md-4 col-lg-4">
                            <a href="#">
                                <div class="banner_box bg-light">
                                    <i class="bi bi-tags-fill" style="font-size: 3rem; color: rgb(255, 115, 0);"></i>
    ...
    <div class="container">
        <div class="latest_post">
            <div class="latest_post_top">
                <h1 class="latest_post_h1 brdr_line">All From <span class="text-warning">{{$tagName}}</span></h1>
            </div>
            <div class="row">
